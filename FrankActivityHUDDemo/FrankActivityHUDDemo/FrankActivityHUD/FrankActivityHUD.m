...
//    hud.isTheOnlyActiveView = NO;
    ...
    if (hud.superview) {
        ...
        UIImageView *tickCrossImageView = [[UIImageView alloc] initWithFrame:CGRectMake(Frame_WidthFor(hud)/2-length/2, length/3, length, length)];
...
- (void)initializeIndicatoeLayerWithType:(FrankActivityHUDShowIndicatorType)type {
    ...
    if (self.isShowLoadingTitle) {
        ...
        self.replicatorLayer.frame = CGRectMake(0, -10, Frame_WidthFor(self), Frame_HeightFor(self));
