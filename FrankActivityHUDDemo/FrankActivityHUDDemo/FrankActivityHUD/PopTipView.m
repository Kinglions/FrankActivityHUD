...
- (void)setRoundBoundWithWidth:(CGFloat)nWidth Radius:(CGFloat)radius WithColor:(UIColor *)color
{
...
- (void)setRoundBoundWithWidth:(CGFloat)nWidth WithColor:(UIColor *)color
{
    [self setRoundBoundWithWidth:nWidth Radius:CGRectGetHeight([self bounds]) / 2 WithColor:color];
}
